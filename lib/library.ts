 ...
 *  touches logged history. Media is best-effort line-art wired up by
 *  scripts/fetch-wger-images.mjs; entries without a matching image fall back to
 *  the ExerciseIcon pictogram. */
...
/** Shorthand: image entry for a matched wger download that exists on disk. */
...
export const LIBRARY: LibraryEntry[] = [
  // ---------------------------------------------------------------- Chest ---
  { slug: "bench-press", name: "Barbell Bench Press", aliasZh: "杠铃卧推", targetMuscle: "Chest", pattern: "press", equipment: "barbell", isWeighted: true, aliases: ["卧推", "平板卧推", "bench"] },
  ...
  { slug: "db-fly", name: "Dumbbell Fly", aliasZh: "哑铃飞鸟", targetMuscle: "Chest", pattern: "press", equipment: "dumbbell", isWeighted: true, aliases: ["飞鸟", "哑铃夹胸"] },
  { slug: "push-up", name: "Push-Up", aliasZh: "俯卧撑", targetMuscle: "Chest", pattern: "press", equipment: "bodyweight", isWeighted: false, aliases: ["俯卧撑", "pushup"] },
  ...
  { slug: "barbell-shrug", name: "Barbell Shrug", aliasZh: "杠铃耸肩", targetMuscle: "Back", pattern: "row", equipment: "barbell", isWeighted: true, aliases: ["耸肩", "斜方肌", "traps"] },
  ...
  { slug: "arnold-press", name: "Arnold Press", aliasZh: "阿诺德推举", targetMuscle: "Shoulders", pattern: "press", equipment: "dumbbell", isWeighted: true, aliases: ["阿诺", "arnold"] },
  ...
  { slug: "lateral-raise", name: "Dumbbell Lateral Raise", aliasZh: "哑铃侧平举", targetMuscle: "Shoulders", pattern: "lateralraise", equipment: "dumbbell", isWeighted: true, aliases: ["侧平举", "中束", "lateral"] },
  ...
  { slug: "rear-delt-fly", name: "Rear Delt Fly", aliasZh: "反向飞鸟", targetMuscle: "Shoulders", pattern: "lateralraise", equipment: "dumbbell", isWeighted: true, aliases: ["后束", "俯身飞鸟", "reverse fly"] },
  ...
  { slug: "upright-row", name: "Upright Row", aliasZh: "直立划船", targetMuscle: "Shoulders", pattern: "row", equipment: "barbell", isWeighted: true, aliases: ["直立划船"] },
  ...
  { slug: "db-curl", name: "Dumbbell Curl", aliasZh: "哑铃弯举", targetMuscle: "Biceps", pattern: "curl", equipment: "dumbbell", isWeighted: true, aliases: ["交替弯举", "哑铃二头"] },
  ...
  { slug: "concentration-curl", name: "Concentration Curl", aliasZh: "集中弯举", targetMuscle: "Biceps", pattern: "curl", equipment: "dumbbell", isWeighted: true, aliases: ["集中弯举"] },
  ...
  { slug: "close-grip-bench-press", name: "Close-Grip Bench Press", aliasZh: "窄距卧推", targetMuscle: "Triceps", pattern: "press", equipment: "barbell", isWeighted: true, aliases: ["窄握卧推", "窄距"] },
  { slug: "triceps-dip", name: "Triceps Dip", aliasZh: "双杠臂屈伸(三头)", targetMuscle: "Triceps", pattern: "pushdown", equipment: "bodyweight", isWeighted: false, aliases: ["双杠", "臂屈伸", "dips"] },
  { slug: "bench-dip", name: "Bench Dip", aliasZh: "凳上臂屈伸", targetMuscle: "Triceps", pattern: "pushdown", equipment: "bodyweight", isWeighted: false, aliases: ["凳上屈伸"] },
  { slug: "db-kickback", name: "Dumbbell Kickback", aliasZh: "哑铃臂屈伸(后踢)", targetMuscle: "Triceps", pattern: "pushdown", equipment: "dumbbell", isWeighted: true, aliases: ["后踢", "kickback"] },
  ...
  { slug: "side-plank", name: "Side Plank", aliasZh: "侧平板支撑", targetMuscle: "Core", pattern: "crunch", equipment: "bodyweight", isWeighted: false, aliases: ["侧平板"] },
  ...
  { slug: "crunch", name: "Crunch", aliasZh: "卷腹", targetMuscle: "Core", pattern: "crunch", equipment: "bodyweight", isWeighted: false, aliases: ["仰卧卷腹"] },
  ...
  { slug: "lying-leg-raise", name: "Lying Leg Raise", aliasZh: "仰卧举腿", targetMuscle: "Core", pattern: "crunch", equipment: "bodyweight", isWeighted: false, aliases: ["仰卧举腿"] },
  ...
  { slug: "bicycle-crunch", name: "Bicycle Crunch", aliasZh: "单车卷腹", targetMuscle: "Core", pattern: "crunch", equipment: "bodyweight", isWeighted: false, aliases: ["单车", "空中蹬车"] },

  // ------------------------------------------------------------ Lower back ---
  { slug: "back-extension", name: "Back Extension", aliasZh: "山羊挺身", targetMuscle: "Lower back", pattern: "crunch", equipment: "bodyweight", isWeighted: false, aliases: ["背伸展", "罗马椅", "hyperextension"] },
  ...
  { slug: "superman", name: "Superman", aliasZh: "超人式", targetMuscle: "Lower back", pattern: "crunch", equipment: "bodyweight", isWeighted: false, aliases: ["飞燕", "超人"] },

  // ----------------------------------------------------------------- Quads ---
  { slug: "barbell-squat", name: "Barbell Back Squat", aliasZh: "杠铃深蹲", targetMuscle: "Quads", pattern: "squat", equipment: "barbell", isWeighted: true, aliases: ["深蹲", "后蹲", "squat"] },
  ...
  { slug: "walking-lunge", name: "Walking Lunge", aliasZh: "行走弓步", targetMuscle: "Quads", pattern: "squat", equipment: "dumbbell", isWeighted: true, aliases: ["弓步", "箭步蹲", "lunge"] },
  ...
  { slug: "glute-bridge", name: "Glute Bridge", aliasZh: "臀桥", targetMuscle: "Glutes", pattern: "squat", equipment: "bodyweight", isWeighted: false, aliases: ["臀桥", "bridge"] },
